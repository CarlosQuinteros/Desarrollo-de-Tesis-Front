...
@Component({
  selector: 'app-crear-suplente',
  templateUrl: './crear-suplente.component.html',
  styleUrls: ['./crear-suplente.component.css']
})
export class CrearSuplenteComponent implements OnInit {
  ...
  crearSuplente(): void {
    let nuevoSuplente = {...this.jugadorPartidoDto};
    nuevoSuplente.idJugador = this.jugador.id!;
    this.jugadorPartidoService.crearSuplente(nuevoSuplente).toPromise().then(
      data => {
