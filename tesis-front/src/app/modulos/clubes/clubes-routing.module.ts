...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'lista',
        component: ListaClubesComponent,
        canActivate: [guardUsuarios],
        data: {rolesEsperados: [ADMIN, ENCARGADO_DE_JUGADORES, ENCARGADO_DE_TORNEOS]},
      },
      {
        path: 'nuevo',
        component: NuevoClubComponent,
        canActivate: [guardUsuarios],
        data: { rolesEsperados: [ADMIN, ENCARGADO_DE_JUGADORES] },
      },
      {
        path: 'detalle/:id',
        component: EditarClubComponent,
        canActivate: [guardUsuarios],
        data: { rolesEsperados: [ADMIN, ENCARGADO_DE_JUGADORES] },
      },
      {
        path: ':id/jugadores',
        component: ListaJugadoresActualesComponent,
        canActivate: [guardUsuarios],
        data: { rolesEsperados: [ADMIN, ENCARGADO_DE_JUGADORES] },
      },
      { path: '**', redirectTo: 'lista' },
